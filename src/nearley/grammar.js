...
var grammar = {
    ...
    {"name": "Statement", "symbols": [lcomment, icomment, rcomment], "postprocess": d => new CommentNode(d[1], d[1].value, true)},
    ...
    {"name": "Statement", "symbols": [keyword_module, identifier, lparent, "Statement$ebnf$1", rparent], "postprocess": d => new ModuleNode(d[1], d[1].value, d[3]/*, d[10]*/)},
    {"name": "Statement$ebnf$2", "symbols": ["Parameters"], "postprocess": id},
    {"name": "Statement$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "Statement", "symbols": [keyword_function, identifier, lparent, "Statement$ebnf$2", rparent, assign, "Expression", eos], "postprocess": d => new FunctionNode(d[2], d[2].value/*, d[6], d[12]*/)},
