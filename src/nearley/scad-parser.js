...
var grammar = {
    ...
    {"name": "Statement", "symbols": [{"literal":"{"}, "_", "Block", "_", {"literal":"}"}]},
    ...
    {"name": "Statement", "symbols": ["Statement$string$4", "__", "Identifier", "_", {"literal":"("}, "_", "Parameters", "_", {"literal":")"}, "_", "Statement", "__"]},
    ...
    {"name": "ModuleInstantiationList", "symbols": ["ModuleInstantiationList", "Statement"]},
    {"name": "ChildrenInstantiation", "symbols": ["ModuleInstantiation"]},
    {"name": "ChildrenInstantiation", "symbols": [{"literal":"{"}, "_", "ModuleInstantiationList", "_", {"literal":"}"}]},
    ...
    {"name": "Expression", "symbols": ["Expression", "_", {"literal":"*"}, "_", "Expression"], "postprocess": d => ([d[0], d[2], d[4]])},
    {"name": "Expression", "symbols": ["Expression", "_", {"literal":"/"}, "_", "Expression"], "postprocess": d => ([d[0], d[2], d[4]])},
    {"name": "Expression", "symbols": ["Expression", "_", {"literal":"%"}, "_", "Expression"], "postprocess": d => ([d[0], d[2], d[4]])},
    {"name": "Expression", "symbols": ["Expression", "_", {"literal":"+"}, "_", "Expression"], "postprocess": d => ([d[0], d[2], d[4]])},
    {"name": "Expression", "symbols": ["Expression", "_", {"literal":"-"}, "_", "Expression"], "postprocess": d => ([d[0], d[2], d[4]])},
    ...
    {"name": "Expression", "symbols": ["Expression", "_", "Expression$string$3", "_", "Expression"], "postprocess": d => ([d[0], d[2], d[4]])},
    {"name": "Expression$string$4", "symbols": [{"literal":"="}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Expression", "symbols": ["Expression", "_", "Expression$string$4", "_", "Expression"], "postprocess": d => ([d[0], d[2], d[4]])},
    {"name": "Expression$string$5", "symbols": [{"literal":"!"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Expression", "symbols": ["Expression", "_", "Expression$string$5", "_", "Expression"], "postprocess": d => ([d[0], d[2], d[4]])},
    {"name": "Expression$string$6", "symbols": [{"literal":">"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Expression", "symbols": ["Expression", "_", "Expression$string$6", "_", "Expression"], "postprocess": d => ([d[0], d[2], d[4]])},
    {"name": "Expression", "symbols": ["Expression", "_", {"literal":">"}, "_", "Expression"], "postprocess": d => ([d[0], d[2], d[4]])},
    {"name": "Expression$string$7", "symbols": [{"literal":"&"}, {"literal":"&"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Expression", "symbols": ["Expression", "_", "Expression$string$7", "_", "Expression"], "postprocess": d => ([d[0], d[2], d[4]])},
    {"name": "Expression$string$8", "symbols": [{"literal":"|"}, {"literal":"|"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Expression", "symbols": ["Expression", "_", "Expression$string$8", "_", "Expression"], "postprocess": d => ([d[0], d[2], d[4]])},
    ...
    {"name": "VectorExpression", "symbols": ["Expression"], "postprocess": id},
