...
var grammar = {
    ...
    {"name": "TermNode", "symbols": [{"literal":"("}, "_", "TermNode", "_", {"literal":")"}], "postprocess": d => d[2]},
    {"name": "TermNode", "symbols": ["ValueNode", "Operator", "ValueNode"], "postprocess": d => new TermNode([d[0],d[2]], d[1])},
    {"name": "TermNode", "symbols": ["TermNode", "Operator", "TermNode"], "postprocess": d => new TermNode([d[0],d[2]], d[1])},
    {"name": "Operator", "symbols": ["_", /[-+*\/]/, "_"], "postprocess": d => d[1]},
