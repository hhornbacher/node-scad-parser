...
var grammar = {
    ...
    {"name": "wschar", "symbols": [/[ \t\n\v\f]/], "postprocess": id},
    {"name": "RootNode", "symbols": ["Block"], "postprocess": id},
    {"name": "Block", "symbols": []},
    ...
    {"name": "Expression", "symbols": ["Expression$string$1"], "postprocess": () => true},
    ...
    {"name": "Expression", "symbols": ["Expression$string$2"], "postprocess": () => false},
    ...
    {"name": "Expression", "symbols": ["Float"], "postprocess": id},
    ...
    {"name": "Expression", "symbols": ["Expression", "_", "Expression$string$7", "_", "Expression"]},
    {"name": "Expression$string$8", "symbols": [{"literal":"|"}, {"literal":"|"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Expression", "symbols": ["Expression", "_", "Expression$string$8", "_", "Expression"]},
    ...
    {"name": "Float", "symbols": ["Integer"], "postprocess": d => parseFloat(d[0])},
